...
# Set 3 results
set3 = {
    "DABT-0141": {"domain": "Domain III", "bloom": "Remember/Understand", "topic": "General Principles & Concepts", "correct": False},
    "DABT-0078": {"domain": "Domain III", "bloom": "Apply", "topic": "Risk Assessment & Regulatory", "correct": False},
    "DABT-0233": {"domain": "Domain I", "bloom": "Apply", "topic": "Skin / Dermatotoxicity", "correct": False},
    "DABT-0391": {"domain": "Domain I", "bloom": "Apply", "topic": "Eye / Ocular Toxicity", "correct": False},
    "DABT-0336": {"domain": "Domain II", "bloom": "Remember/Understand", "topic": "Carcinogenesis & Mutagenesis", "correct": True}
}
...
# Sample set 4 — odd goes to Applied this round
...
print(f"RA: {len(ra_pool)}, Conduct: {len(conduct_pool)}, Applied: {len(applied_pool)}")
