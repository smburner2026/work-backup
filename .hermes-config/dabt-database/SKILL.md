...
**Quarantine complete (2026-05-20):** 1,048 low-quality questions moved to quarantine tables. Main table: **3,796** clean questions (+3 user-contributed since quarantine). Residual issues: **62 Qs from source 6 lack domain classification**, **1,725 Qs have answer letter but NULL answer text**, **61 explanations are ≤50 char placeholders**, **~45 batch33 Qs (DABT-1800+) have ~82% error rate** needing audit. See `dabt-project-workflow` → `references/task-roadmap.md` for full tracking. Weekly truth audit Sundays 05:00 UTC.
