...
- `references/vault-to-git-migration.md` — pattern for migrating a vault from local-only to GitHub-backed (or vice versa). What survives, what doesn't, how to backfill.
